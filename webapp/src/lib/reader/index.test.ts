...
import type { ReaderCatalog, ReaderStructureResponse, ReaderWorkDossierResponse } from './index';
import {
...
const readerSource = readFileSync(new URL('./index.ts', import.meta.url), 'utf8');
