<script lang="ts">
	...
	import DeskWordIndexEarmarks from '$lib/DeskWordIndexEarmarks.svelte';
	import DeskWordIndexRows from '$lib/DeskWordIndexRows.svelte';
	import DeskWordIndexSections from '$lib/DeskWordIndexSections.svelte';
	import type { LanguageMode } from '$lib/search-data';
	import type { WordIndexItem, WordIndexSection } from '$lib/word-index';
	import { uiCopy } from '$lib/ui-copy';

	type WordIndexMergedPosition = 'before' | 'anchor' | 'after' | 'nearby' | 'browse';
