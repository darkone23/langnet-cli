<script lang="ts">
	...
	import DeskComponentLedger from '$lib/DeskComponentLedger.svelte';
	import DeskDictionaryGroupCard from '$lib/DeskDictionaryGroupCard.svelte';
	import DeskLookupLoadingPanel from '$lib/DeskLookupLoadingPanel.svelte';
	import DeskParadigmPanel from '$lib/DeskParadigmPanel.svelte';
