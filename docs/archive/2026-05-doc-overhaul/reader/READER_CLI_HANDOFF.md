> Archived during the 2026-05 documentation overhaul. Retained for historical
> context; current guidance lives in `docs/READER_CLI_BEGINNER_GUIDE.md`,
> `docs/READER_CORPUS_STATUS.md`, and `docs/READER_DATA_BUILD.md`.
