...
**Date**: 2026-02-15
**Prerequisite For**: classifier-and-reducer.md (WSU extraction)
...
ParsedEntry (clean, structured)
       ↓
┌─────────────────────────────────────┐
│  WSU EXTRACTION (classifier-and-reducer)     │
...
*This layer is a prerequisite for the WSU extraction defined in `classifier-and-reducer.md`.*