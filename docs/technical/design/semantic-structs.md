...
**Prerequisites**: `entry-parsing.md` (Parsing produces clean ParsedEntry objects)
...
Lemma Hypotheses
    ↓
Entry Parsing (NEW - see entry-parsing.md)
    ↓
...
* [ ] **Entry parsing layer implemented** (see `entry-parsing.md`)
