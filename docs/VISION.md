# Project Orion / LangNet Vision

Project Orion is the public product: a classical-language lookup and reader
experience. LangNet is the internal evidence engine, CLI, data-build system, and
developer contract underneath it.

LangNet exists to help a reader move from a word in a classical text to possible
headwords, grammatical forms, source-supported meanings, reader references, and
the caveats around that answer.
...
The answer should be useful first and source-visible throughout. A beginner
should see a clear reading path; an advanced user should be able to drill down
into claims, triples, raw source references, reader provenance, and cache
provenance.
...
Build a reliable word-level evidence engine first. Then reduce that evidence
into grouped meanings and reader context that make classical texts easier to
read without hiding the sources.
